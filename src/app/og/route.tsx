...
> {
  const [{ base64Font: normal }, { base64Font: mono }] = await Promise.all([
  ...
  const ogComponent = (
    ...
    >
      ...
      <div tw="flex flex-col absolute w-[896px] justify-center inset-32">
        <div
          tw="tracking-tight flex-1 flex flex-col justify-center leading-[1.1]"
          style={{
            textWrap: "balance",
            fontWeight: 400,
        ...
        <div
          tw="text-[40px] leading-[1.5] flex-1 text-neutral-400"
          style={{
            fontWeight: 400,
            textWrap: "balance",
          }}
