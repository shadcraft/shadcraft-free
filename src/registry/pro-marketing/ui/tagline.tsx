...
const taglineVariants = cva(
  "inline-flex w-fit shrink-0 items-center justify-center gap-1 text-xs font-medium whitespace-nowrap [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-3.5 [&>svg]:pointer-events-none",
  {
    variants: {
      variant: {
        default: "text-base font-medium text-primary",
        primary:
        ...
        badge:
          "rounded-md border bg-background px-2 py-0.5 text-foreground [a&]:hover:bg-accent [a&]:hover:text-accent-foreground",
        outline:
