  ...
  return (
    <section className="py-12 lg:py-20">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="bg-muted flex flex-col items-center justify-between gap-12 rounded-xl border px-5 py-12 lg:flex-row lg:items-end lg:gap-16 lg:px-16 lg:py-20">
          {/* Section Heading */}
          ...
          <div className="flex max-w-md flex-col gap-2 lg:gap-3">
            ...
            {/* Privacy Policy */}
            <span className="text-muted-foreground text-center text-xs/4 lg:text-right" role="note">
